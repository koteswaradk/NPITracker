...
public class SessionManager {
	...
	public static final String KEY_ROLE_IS_MANAGER="ismanager";
	...
	public void createLoginSession(String name, String password , String userid,
								   String apikey,String designation,boolean ismanager){
		...
		editor.putBoolean(KEY_ROLE_IS_MANAGER, ismanager);
	...
	/*public void checkLogin(){
		...
		if(!this.isLoggedIn()){
			...
			Intent i = new Intent(_context, JdiLogin.class);
	...
	public HashMap<String, String> getUserDetails(){
		...
		user.put(KEY_ROLE_IS_MANAGER, pref.getString(KEY_ROLE_IS_MANAGER, null));

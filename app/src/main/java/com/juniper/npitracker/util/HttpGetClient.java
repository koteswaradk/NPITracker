...
public class HttpGetClient {
	...
	public static JSONObject sendHttpPost(String URL){
		...
		System.out.println("inside HttpGetClient "+URL);
		try {
			...
			{
				System.out.println("inside HttpGetClient "+Util.API_TOKEN);
				//printing URL
				System.out.println(URL);

				httpGetRequest.setHeader("X-Auth-Token", Util.API_TOKEN);
				System.out.println("Api Token Inside The "+Util.API_TOKEN);
				httpGetRequest.setHeader("user_id", Util.USER_ID);
				System.out.println("user_id"+Util.USER_ID);
			}
			...
			System.out.println("inside HttpGetClient "+response.getAllHeaders());

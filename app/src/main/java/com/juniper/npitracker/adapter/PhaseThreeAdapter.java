...
public class PhaseThreeAdapter extends BaseAdapter implements Filterable {
    private static final String TAG= "NPITrackerAdapter";
    private LayoutInflater layoutInflater;
    public ArrayList<PhaseThreeModel> _alnpitracker;
    public ArrayList<PhaseThreeModel> orig;
    ...
    public PhaseThreeAdapter(Context context,ArrayList<PhaseThreeModel> alnpitracker ){
    ...
    public View getView(final int position, View convertView, ViewGroup viewGroup) {
        PhaseThreeAdapter.ViewHolder viewHolder=null;
        ...
        if(convertView == null){
            ...
            viewHolder = new PhaseThreeAdapter.ViewHolder();
            ...
            viewHolder = (PhaseThreeAdapter.ViewHolder) convertView.getTag();
        }
        final PhaseThreeModel activeReleModelItem = (PhaseThreeModel) _alnpitracker.get(position);
            ...
            public void onClick(View v) {
                if(((CheckBox)v).isChecked()) {
                  ...
                  /*  checkedlist.add(activeReleModelItem.getNpiname());
                    ...
                    values.put(NPITrackerDBHelper.KEY_NPITRACKER_PHASE, "P3");
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                final ArrayList<PhaseThreeModel> results = new ArrayList<PhaseThreeModel>();

                if (orig == null)
                    orig = _alnpitracker;
                   // orig.addAll(_alnpitracker);
                if (charSequence != null) {
                    if (orig != null && orig.size() > 0) {
                        for (final PhaseThreeModel g : orig) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                _alnpitracker = (ArrayList<PhaseThreeModel>) filterResults.values;
                notifyDataSetChanged();
            }
        };
    }

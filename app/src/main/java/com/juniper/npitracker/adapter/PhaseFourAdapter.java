...
public class PhaseFourAdapter extends BaseAdapter implements Filterable {
    private static final String TAG= "NPITrackerAdapter";
    private LayoutInflater layoutInflater;
    public ArrayList<PhaseFourModel> _alnpitracker;
    public ArrayList<PhaseFourModel> orig;
    ...
    public PhaseFourAdapter(Context context,ArrayList<PhaseFourModel> alnpitracker ){
    ...
    public View getView(final int position, View convertView, ViewGroup viewGroup) {
        PhaseFourAdapter.ViewHolder viewHolder=null;
        ...
        if(convertView == null){
            ...
            viewHolder = new PhaseFourAdapter.ViewHolder();
            ...
            viewHolder = (PhaseFourAdapter.ViewHolder) convertView.getTag();
        }
        final PhaseFourModel activeReleModelItem = (PhaseFourModel) _alnpitracker.get(position);
        ...
        viewHolder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(conn.isConnectingToInternet()) {
                    ...
                    dropTable();
                   // new PhaseFourAdapter.NPIDetailsAsychtask().execute(activeReleModelItem.getNpiid());
            ...
            public void onClick(View v) {
                if(((CheckBox)v).isChecked()) {
                  ...
                  /*  checkedlist.add(activeReleModelItem.getNpiname());
                    ...
                    values.put(NPITrackerDBHelper.KEY_NPITRACKER_PHASE, "P4");
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                final ArrayList<PhaseFourModel> results = new ArrayList<PhaseFourModel>();
                if (orig == null)
                    orig = _alnpitracker;
                if (charSequence != null) {
                    if (orig != null && orig.size() > 0) {
                        for (final PhaseFourModel g : orig) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                _alnpitracker = (ArrayList<PhaseFourModel>) filterResults.values;
                notifyDataSetChanged();
            }
        };
    }

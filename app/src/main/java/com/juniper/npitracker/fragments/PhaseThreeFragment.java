...
public class PhaseThreeFragment extends Fragment {
    ...
    ListView listviewphasethree;
    SearchView searchview;
    PhaseThreeAdapter adapter;
    Button button;
    private ArrayList<PhaseThreeModel> npiTrackerModels = new ArrayList<PhaseThreeModel>();
    public PhaseThreeFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_phase_three, container, false);
        searchview=(SearchView)view.findViewById(R.id.phasethree_searchview);
        listviewphasethree=(ListView) view.findViewById(R.id.phase_three_listview);
        button=(Button)view.findViewById(R.id.phase3save);
       ...
       /* button.setOnClickListener(new View.OnClickListener() {
        ...
        if (cursor.moveToFirst()) {
            do{
                ...
                adapter=new PhaseThreeAdapter(getActivity(),npiTrackerModels);
                listviewphasethree.setAdapter(adapter);
...
//                mCloseButton.setVisibility(newText.isEmpty() ? View.GONE : View.VISIBLE);
                ...
                if (TextUtils.isEmpty(newText)) {
                    listviewphasethree.clearTextFilter();
                    npiTrackerModels.clear();
                    ...
                    PhaseThreeAdapter ca = (PhaseThreeAdapter)listviewphasethree.getAdapter();
    ...
    private ArrayList<PhaseThreeModel> parseDbStringValues(String jsonStr) {
        if (jsonStr!=null) {
            try {
                ...
                JSONArray m_jArry = obj.getJSONArray("npilistP3");

                for (int i = 0; i < m_jArry.length(); i++) {
                    JSONObject jo_inside = m_jArry.getJSONObject(i);

                    PhaseThreeModel model = new PhaseThreeModel();
